...
class UserAdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_admin" do
    assert_difference('UserAdmin.count') do
      post user_admins_url, params: { user_admin: { bio: @user_admin.bio, email: @user_admin.email, name: @user_admin.name, password: @user_admin.password, photo: @user_admin.photo, surname: @user_admin.surname } }, as: :json
    end
  ...
  test "should update user_admin" do
    patch user_admin_url(@user_admin), params: { user_admin: { bio: @user_admin.bio, email: @user_admin.email, name: @user_admin.name, password: @user_admin.password, photo: @user_admin.photo, surname: @user_admin.surname } }, as: :json
    assert_response 200
  end
